...
const ENV_CONFIG: Record<Env, { BASE_URL: string;APP_URL: string;MAP_URL:string,Accesibility_URL:string,Private_Policy_URL:string,Guidance_URL:string,Understand_Data_URL:string}> = {
  dev: {
