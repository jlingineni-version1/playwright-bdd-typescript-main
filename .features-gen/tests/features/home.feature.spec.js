...
test.describe('Home Page Login Functionality', () => {
  ...
  test('Home page Open Government Licence', { tag: ['@home', '@regression'] }, async ({ When, Then, homePage }) => { 
    await When('I click the on Open Government Licence check and validate the Open Government Licence page is displayed successfully', null, { homePage }); 
    await Then('navigate back to home page', null, { homePage }); 
  });

  test('Home page Crown copyright', { tag: ['@home', '@regression'] }, async ({ When, Then, homePage }) => { 
    await When('I click the on Crown copyright check and validate the Crown copyright page is displayed successfully', null, { homePage }); 
    await Then('navigate back to home page', null, { homePage }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":20,"pickleLine":17,"tags":["@home","@regression"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I am on the home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":21,"gherkinStepLine":18,"keywordType":"Action","textWithKeyword":"When I click the on Open Government Licence check and validate the Open Government Licence page is displayed successfully","stepMatchArguments":[]},{"pwStepLine":22,"gherkinStepLine":19,"keywordType":"Outcome","textWithKeyword":"Then navigate back to home page","stepMatchArguments":[]}]},
  {"pwTestLine":25,"pickleLine":22,"tags":["@home","@regression"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I am on the home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":26,"gherkinStepLine":23,"keywordType":"Action","textWithKeyword":"When I click the on Crown copyright check and validate the Crown copyright page is displayed successfully","stepMatchArguments":[]},{"pwStepLine":27,"gherkinStepLine":24,"keywordType":"Outcome","textWithKeyword":"Then navigate back to home page","stepMatchArguments":[]}]},
  {"pwTestLine":30,"pickleLine":27,"tags":["@footer","@regression"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I am on the home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":31,"gherkinStepLine":28,"keywordType":"Action","textWithKeyword":"When I click the on accessibility check and validate the accessibility statement page is displayed successfully","stepMatchArguments":[]},{"pwStepLine":32,"gherkinStepLine":29,"keywordType":"Outcome","textWithKeyword":"Then navigate back to home page","stepMatchArguments":[]}]},
  {"pwTestLine":35,"pickleLine":32,"tags":["@footer","@regression"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I am on the home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":36,"gherkinStepLine":33,"keywordType":"Action","textWithKeyword":"When I click on privacy policy link and validate the privacy policy page is displayed successfully","stepMatchArguments":[]},{"pwStepLine":37,"gherkinStepLine":34,"keywordType":"Outcome","textWithKeyword":"Then navigate back to home page","stepMatchArguments":[]}]},
  {"pwTestLine":40,"pickleLine":37,"tags":["@footer","@regression"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I am on the home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":41,"gherkinStepLine":38,"keywordType":"Action","textWithKeyword":"When I click on guidance link and validate the guidance page is displayed successfully","stepMatchArguments":[]},{"pwStepLine":42,"gherkinStepLine":39,"keywordType":"Outcome","textWithKeyword":"Then navigate back to home page","stepMatchArguments":[]}]},
  {"pwTestLine":45,"pickleLine":42,"tags":["@regression","@footer"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I am on the home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":46,"gherkinStepLine":43,"keywordType":"Action","textWithKeyword":"When I click on nav header guidance link and validate the guidance page is displayed successfully","stepMatchArguments":[]},{"pwStepLine":47,"gherkinStepLine":44,"keywordType":"Outcome","textWithKeyword":"Then navigate back to home page","stepMatchArguments":[]}]},
  {"pwTestLine":50,"pickleLine":47,"tags":["@footer","@regression"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I am on the home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":51,"gherkinStepLine":48,"keywordType":"Action","textWithKeyword":"When I click on understand the data link and validate the understand the data page is displayed successfully","stepMatchArguments":[]},{"pwStepLine":52,"gherkinStepLine":49,"keywordType":"Outcome","textWithKeyword":"Then navigate back to home page","stepMatchArguments":[]}]},
]; // bdd-data-end